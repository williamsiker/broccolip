...
extern "C" {
    ...
    Java_com_example_amogusapp_MainUI_nativeTestConnection(JNIEnv *env, jobject instance, jstring jFtpUrl){
    ...
    /* FTP UPLOAD FUNCTION */
    JNIEXPORT jboolean JNICALL
    Java_com_example_amogusapp_MainUI_uploadFileToFTP(
            JNIEnv *env,
            jobject instance,
            jstring jFtpUrl,
            jstring jFilepath
    ...
    Java_com_example_amogusapp_MainUI_fetchPageContent(JNIEnv *env, jobject) {
        CURL *curl;
        CURLcode res;
